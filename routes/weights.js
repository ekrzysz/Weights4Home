...
router.post('/', function(req, res, next) {
    ...
    let insertquery = "INSERT INTO weight_products (product_name, brand, pound, color) VALUES (?, ?, ?, ?)"; 
    
    db.query(insertquery,[req.body.product_name, req.body.brand, req.body.pound, req.body.color],(err, result) => {
        if (err) {
                console.log(err);
                res.render('error');
            } else {
...
router.post('/save', function(req, res, next) {
	let updatequery = "UPDATE weight_products SET product_name = ?, brand = ?, pound = ?, color = ? WHERE product_id = " + req.body.product_id; 

	db.query(updatequery,[req.body.product_name, req.body.brand, req.body.pound, req.body.color],(err, result) => {
		if (err) {
			console.log(err);
			res.render('error');
		} else {
